...
export default class ObservableCollection {
     ...
     * @param {*} param
     */
    constructor({ multiplexer, matcher, sorter, cursorDescription, mongoConnection }) {
        ...
        this.channels = getChannels(this.mongoConnection, this.collectionName, this.options);
